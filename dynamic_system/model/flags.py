...
def get_flags():
    ...
    parser.add_argument("--n_epoch", default=6e4, type=int, help="Number of epochs for each homotopy step")
    parser.add_argument("--batch", default=4096, type=int, help="Number of epochs for each homotopy step")
